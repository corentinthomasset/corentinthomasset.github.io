...
<template>
  <div
    ...
    :delay="150 + index * 100"
  >
    <video v-if="item.thumbnailMedia" ref="video-el" class="aspect-2/3 w-full object-cover md:aspect-3/2" muted loop disablepictureinpicture :poster="item.thumbnailPoster">
  ...
  <div class="m-auto max-w-[900px] p-6 text-center" v-motion-fade :delay="200 + index * 100">
