...
export default [
    ...
    {
        "title": "Nearbuy",
        "description": "Chrome extension that finds nearby pre-owned alternatives while shopping online. Includes a scraping backend and an intuitive UI to surface eco‑friendly secondhand options. 2nd runner up at IBM Call for Code 2022.",
        "date": "2022",
    ...
    {
        "title": "SERENIoT",
        "description": "Academic research project implementing a distributed system for real-time security policy management and enforcement in IoT home networks, with a custom JavaScript ledger and real-time visualization.",
        "date": "2020",
